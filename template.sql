...
--
-- Host: localhost
-- Generation Time: Jan 12, 2015 at 05:09 
...
CREATE TABLE IF NOT EXISTS `tpl_lookup` (
  ...
  `usercreate` bigint(11) unsigned DEFAULT NULL,
  `dateupdate` datetime DEFAULT NULL,
  `userupdate` bigint(20) unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tpl_menu` (
  ...
  `datecreate` datetime DEFAULT NULL,
  `usercreate` bigint(20) unsigned DEFAULT NULL,
  `dateupdate` datetime DEFAULT NULL,
  `userupdate` bigint(20) unsigned DEFAULT NULL,
  PRIMARY KEY (`menu_id`)
...
(2, 'User', '', 1, '', 2, 1, NULL, NULL, '2015-01-12 16:47:00', NULL),
